     ...
     <div class="box box-primary">
              ...
              <div class="form-group">
                ...
                <select id="mainCategory" name="cate_prt" class="form-control select2 select2-hidden-accessible" style="width: 100%;">
                 ...
                 <c:forEach items="${mainCategory }" var="vo">
                  <option value="${vo.cate_code }" <c:out value="${vo.cate_code == productVO.cate_prt ? 'selected' : '' }"/>>${vo.cate_name }</option>
              	</c:forEach>
                 </select>
              </div>
              </div>
           <div class="col-md-6">   
              <div class="form-group">
                ...
                <select id="subCategory" name="cate_code" class="form-control select2 select2-hidden-accessible" style="width: 100%;">
                 <c:forEach items="${subCategory}" var="vo">
                 	<option value="${vo.cate_code }" <c:out value="${vo.cate_code == productVO.cate_code ? 'selected' : '' }"/>>${vo.cate_name }</option>
                 </c:forEach>
              ...
              <div class="row">
               <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" id="pdt_code" name="pdt_code" value="${productVO.pdt_code }">
                </div>
               </div>
               <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="box-body pad">             
              ...
              <c:out value="${productVO.pdt_detail }"></c:out>
              </textarea>              
            </div>
          </div>
                </div>
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="pdt_price" name="pdt_price" value="${productVO.pdt_price }" placeholder="">
                </div>
                </div>
                <div class="col-md-3">
                <div class="form-group">
                  <label for="pdt_discount">할인</label>
                  <input type="text" class="form-control" id="pdt_discount" name="pdt_discount" value="${productVO.pdt_discount }" placeholder="">
                </div>
                </div>
                <div class="col-md-3">
                <div class="form-group">
                  <label for="pdt_amount">수량</label>
                  <input type="text" class="form-control" id="pdt_amount" name="pdt_amount" value="${productVO.pdt_amount }" placeholder="">
                </div>
                </div>
                <div class="col-md-3">
 				<div class="form-group">
                  ...
                  <div class="checkbox">
                  <label>
                      <input type="checkbox" name="pdt_buy" <c:out value="${productVO.pdt_buy == 'Y' ? 'checked' : '' }"/>>
                    	  판매여부
                    </label>
                    </div>             
                </div>
